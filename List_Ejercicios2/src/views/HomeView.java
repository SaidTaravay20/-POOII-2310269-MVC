...
public class HomeView extends JPanel implements View {
    ...
    private JTabbedPane tabbedPane;  // Añadido para manejar las pestañas
    ...
    public void update(Model model, Object data) {
        // TODO: Por ejemplo, si queremos cargar una lista de datos al iniciar el aplicativo y existe un error
    }
    ...
    private void make_tabs() {
        ...
        tabbedPane.addTab("Registrar invitado", new JPanel());  // Placeholder
        tabbedPane.addTab("Buscar evento", new JPanel());  // Placeholder
        add(tabbedPane, BorderLayout.CENTER);
    }

    /**
     * Getter for the JTabbedPane, used to add new tabs dynamically.
     */
